...
# Conclusion 
To conclude, the research shows that the way an organisation should react to repeat clickers is extremely complicated and should be thought about. Things such as cognitive, emotional and situational factors highlighted by Canham shows that some repeat clickers may have cognitive deficiencies and thus may struggle to recall training and awareness. Although sample size of that study was small. Whereas Shiller shows that things like time pressure, stress and internet anxiety are drivers beind phishing susceptibility. Their study also has good population validity. Things like locus of control, need for cognition and narcisism also have been shown to influence someones phishing susceptibility thus suggesting it's going to be very tricky to prevent it 100%. More research needs to be done and whether phishing simulations are worth the financial drain on an organisation. 
