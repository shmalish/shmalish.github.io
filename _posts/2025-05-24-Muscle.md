...
LAST UPDATE 08/02/2026 - Fixed upper lower table and made changes to cutting 
...
|             | Diverging Lat Pulldown (Machine)                  | 2        | 5-8     |
|             | T-Bar Row                               | 2        | 5-8     |
|             | Bicep Machine                           | 2        | 5-8     |
|             | Chest Press Machine or Pec Deck         | 2        | 5–8      |
|             | Dips (Weighted if able)                 | 2        | 5–8     |
|             |                                        |          |          |
| **Lower A** | Belt Squats / Hack squat / Barbell Squat                            | 2        | 5–8      |
|             | Hamstring Curl                          | 2        | 5–8      |
|             | Leg Extension                           | 2        | 5–8      |
|             | Adductors / Abductors                  | 2        | 5–8      |
|             | Abs                                    | 2        | 5–8      |
|             |                                        |          |          |
| **Upper B** | Weighted Pull-Ups                       | 2        | 5–8      |
|             | T-Bar Row                               | 2        | 5–8      |
|             | Bicep Machine                           | 2        | 5–8      |
|             | Incline Bench Press                    | 2        | 5-8     |
|             | Dips (Weighted if able)                 | 3        | 8–12     |
|             | Side Delts                              | 3        | 8-12    |
|             |                                        |          |          |
...
With this upper lower program, when I say 2 sets that means 2 "top sets". For example if your top set for bench press is 80kg, you would warm up first set with let's say 60kg then if you need to, another warm up set of 70kg just to wake up the CNS. Then you do 80kg for 2 sets resting 5 minutes inbetween each set. After that you do 1 or 2 backoff sets which must match the reps you attained on your top set. For example, if you attained 5 reps with 80kg, you might drop down to 75kg and do that for 5 reps. If your top set isn't increasing then you can add the second backoff set of like 70kg for 8-10 reps but only do the extra backoff sets when bulking. 


When cutting, what works for me is 1 top set, 1 backoff set and both sets I MUST match the reps I got when I was at my bulk. It may feel impossible and you might need an assisted rep or 2 but you have to do it this way to retain muscle. 
...
08/02/2026
My opinions on cutting have now changed. After cutting for an extended period of time at a low and slow deficit and neglecting micronutrients and fat intake, my immune system shutdown and I developed shingles and crashed my testosterone to 550ng/dl lol. I at that point didn't "feel my hormones" crashing but I guess they did and only noticed them coming back when I started eating at maintainance again. I now believe it is better to do an aggressive minicut (Look up TNF on youtube for this) for about 4 weeks. This involves a 1000 calorie deficit + some form of cardio i.e 10k steps or running. The main benefit of this is because it's a very short term cut, you mitigate the risk of long term hormone damage and muscle loss. You must retain strength you achieved during your bulk with the same reps but you do less sets to save on CNS and lack of glycogen. Consume carbs 30 minutes before and after your workout as well for IGF-1 signalling shenanigans. For me the first 3 days were horrible and I couldn't think properly. After that I feel about 80% better but I definitely notice coginitive decline due to a lack of available glucose. I take a multi vitamin + electrolytes and eat 100g beef liver a week to mitigate the risk of low micros. 
